        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Discover and compare international university courses from around the world. 
              Find your perfect educational path with our comprehensive course aggregator platform.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center mt-4 md:mt-0">
              <button
                onClick={toggleTheme}
                className="text-gray-400 hover:text-white p-2 rounded-md mr-2"
              >
